...
while True:
	...
	if len(cnts) > 0:
		...
		for contour in cnts:
			...
			if int(perimeter) != 0: # and int(area) != 201863: #Perimeter to avoid divide by 0, and area so it doesn't take the whole image as contour (this will depend on the image i think)
